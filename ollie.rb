...
class Ollie < Formula
    ...
    on_macos do
      if Hardware::CPU.arm?
        url "https://github.com/TeamGoodOnes/ollie-cli/releases/download/v0.0.1/ollie-cli_Darwin_arm64.tar.gz", :using => :github_private_release
      ...
      if Hardware::CPU.intel?
        url "https://github.com/TeamGoodOnes/ollie-cli/releases/download/v0.0.1/ollie-cli_Darwin_x86_64.tar.gz", :using => :github_private_release
